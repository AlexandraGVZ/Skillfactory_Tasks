...
2. Обработка данных значительно улучшает целевую метрику. Наилучшие результаты на обработанных данных были получены для  градиентного бустинга (f1_score_macro=0.50 на кросс-валидации).
