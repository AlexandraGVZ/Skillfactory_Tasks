...
По условию данной задачи, нужно пользоваться только RandomForestRegressor с заранее установленными параметрами. Другие модели использовать нельзя. Метрика для оценки качества модели задана заранее - mean_absolute_error. Проверить на переобучение модель нельзя. 
